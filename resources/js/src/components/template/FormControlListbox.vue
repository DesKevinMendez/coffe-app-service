...
<template>
  <Listbox v-slot="{ open }" v-model="computedValue">
    <div class="relative">
      ...
      >
        <ListboxOptions class="list-box-content">
          <ListboxOption
...
<style type="scss">
.list-box-content {
  @apply absolute z-50 w-full mt-2 overflow-auto text-base bg-white rounded
  shadow-lg ring-1 ring-black ring-opacity-5 max-h-60 focus:outline-none
  sm:text-sm dark:bg-slate-800;
}
</style>
